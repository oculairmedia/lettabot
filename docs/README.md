...
- [Channel Adapter Contract](./channel-adapter-contract.md) - Wire contract for channel authors and WS gateway consumers (default one-frame-per-call; opt-in progressive tool_call snapshots via `?progressive_tool_calls=1`)
