...
- [Channel Adapter Contract](./channel-adapter-contract.md) - Wire contract for channel authors and WS gateway consumers (snapshot semantics, dedup by tool_call_id)
