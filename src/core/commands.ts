...
export const COMMANDS = ['status', 'heartbeat', 'reset', 'cancel', 'stop', 'approve', 'disapprove', 'help', 'start', 'model', 'setconv'] as const;
...
/stop - Force stop all runs, gateway sessions, and drain queue
